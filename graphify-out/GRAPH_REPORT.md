...
## Corpus Check
- 213 files · ~4,156,427 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1042 nodes · 1328 edges · 39 communities detected
...
- **Thin community `Community 29`** (7 nodes): `fadeUp()`, `GhostListing()`, `GhostSlot()`, `Listing()`, `NWAMap()`, `StarRating()`, `GhostListing.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (4 nodes): `FunnelParticle()`, `SearchFunnel()`, `useCountUp()`, `SearchFunnel.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (3 nodes): `Main()`, `uninstall.ps1`, `Write-Color()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (3 nodes): `validate_setup.py`, `check()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
