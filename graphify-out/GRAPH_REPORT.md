...
## Corpus Check
- 182 files · ~1,838,047 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 977 nodes · 1269 edges · 38 communities detected
...
2. `generate_report()` - 19 edges
3. `_make_finding()` - 19 edges
4. `generate_report()` - 18 edges
5. `validate_url()` - 13 edges
6. `load_config()` - 12 edges
7. `get_oauth_credentials()` - 12 edges
8. `Google Business Profile Optimization Guide for Contractors` - 12 edges
9. `Local SEO for Contractors: The Complete Guide` - 12 edges
10. `get_domain_metrics()` - 10 edges
...
- **Thin community `Community 28`** (7 nodes): `fadeUp()`, `GhostListing()`, `GhostSlot()`, `Listing()`, `NWAMap()`, `StarRating()`, `GhostListing.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (4 nodes): `FunnelParticle()`, `SearchFunnel()`, `useCountUp()`, `SearchFunnel.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (3 nodes): `Main()`, `uninstall.ps1`, `Write-Color()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (3 nodes): `validate_setup.py`, `check()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
