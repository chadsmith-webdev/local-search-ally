...
## Corpus Check
- 243 files · ~4,422,277 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1109 nodes · 1368 edges · 42 communities detected
...
- **Thin community `Community 29`** (7 nodes): `fadeUp()`, `GhostListing()`, `GhostSlot()`, `Listing()`, `NWAMap()`, `StarRating()`, `GhostListing.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (5 nodes): `generateMetadata()`, `SiloamSpringsElectricalPage()`, `SpringdaleElectricalPage()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (5 nodes): `generateMetadata()`, `SiloamSpringHvacPage()`, `SpringdaleHvacPage()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
