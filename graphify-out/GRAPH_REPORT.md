...
## Corpus Check
- 247 files · ~4,426,573 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1117 nodes · 1374 edges · 44 communities detected
...
- **Thin community `Community 34`** (5 nodes): `generateMetadata()`, `SiloamSpringPlumbingPage()`, `SpringdalePlumbingPage()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (5 nodes): `generateMetadata()`, `SiloamSpringsElectricalPage()`, `SpringdaleElectricalPage()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (5 nodes): `generateMetadata()`, `SiloamSpringHvacPage()`, `SpringdaleHvacPage()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (5 nodes): `generateMetadata()`, `SiloamSpringsLandscapingPage()`, `SpringdaleLandscapingPage()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (5 nodes): `generateMetadata()`, `SiloamSpringsRemodelingPage()`, `SpringdaleRemodelingPage()`, `page.js`, `page.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (4 nodes): `FunnelParticle()`, `SearchFunnel()`, `useCountUp()`, `SearchFunnel.jsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (3 nodes): `Main()`, `uninstall.ps1`, `Write-Color()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (3 nodes): `validate_setup.py`, `check()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
