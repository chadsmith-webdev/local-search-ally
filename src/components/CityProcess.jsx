...
import styles from "./CityProcess.module.css";
...
export default function CityProcess() {
  return (
      ...
      >
        ...
        <motion.div className={styles.header} variants={fadeUp}>
          ...
          <p className={styles.lead}>
            ...
            get executed. Here's exactly what working together looks like.
          </p>
        </motion.div>
        ...
        <motion.div className={styles.noteRow} variants={fadeUp}>
          <div className={styles.note}>
            ...
            <p className={styles.noteText}>
              ...
              month-to-month. You stay because it's working — not because you're
              locked in.
            </p>
          </div>
