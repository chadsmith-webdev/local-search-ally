...
const diagnostics = [
  {
    ...
    status: "INCOMPLETE",
    statusType: "warn",
    title: "Your Google Business Profile is doing less than half the job.",
  ...
  },
  {
    ...
    statusType: "error",
    title: "Your business appears differently across the web.",
  ...
  },
  {
    ...
    status: "NOT IN TOP 3",
    statusType: "error",
    title: "The Map Pack rewards visibility — not quality.",
