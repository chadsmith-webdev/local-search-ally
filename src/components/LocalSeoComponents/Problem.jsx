        ...
        <div className={styles.contentGrid}>
          <div className={styles.problemsList}>
            ...
            >
              ...
              <motion.div variants={fadeUp} className={styles.problem}>
                ...
                <p>
                  Google shows review count and rating directly in search
                  results. Without a review strategy, you look less trustworthy
                  than competitors — even if you do better work.
                </p>
              </motion.div>
              ...
              <motion.div variants={fadeUp} className={styles.problem}>
                ...
                <p>
                  National franchises and larger companies dominate search
                  results in your market. They spend money on Google Ads. You
                  can't compete with that budget. But you can rank locally
          ...
          <div className={styles.statColumn}>
            ...
            >
              ...
              <p>
                These are homeowners actively looking to hire someone in your
                area — right now. If you're not visible, that call goes to your
                competitor.
              </p>
