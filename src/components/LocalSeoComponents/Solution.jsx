      ...
      <div className={styles.container}>
        ...
        >
          ...
          <p className={styles.intro}>
            ...
            rankings on Google: your Google Business Profile, local citations,
            and on-page SEO.
          </p>
        </motion.div>
        ...
        >
          ...
          <p>
            ...
            Google Search results when someone searches for your service. That's
            where the phone calls come from. Everything else is secondary.
          </p>
        </motion.div>
