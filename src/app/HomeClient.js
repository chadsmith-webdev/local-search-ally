  ...
  return (
    <div className="tech-grid" style={{ background: "#060607", minHeight: "100vh" }}>
      ...
      <div className="noise">
        ...
        {/* ─── PROBLEM ───────────────────────────────────────────────────────── */}
        <section style={{ padding: "0 clamp(1.5rem, 5vw, 3rem) clamp(5rem, 10vw, 8rem)" }}>
            ...
            >
              ...
              >
                <div style={{
                  ...
                  <span style={{ width: 4, height: 4, background: C.carolina, borderRadius: "50%" }} />
                  SYSTEMS_ARCHITECT
                </div>
                <p style={{
                  color: C.text,
        ...
        <section style={{
          ...
          <div className="stakes-grid">
            <div style={{
              aspectRatio: "1/1", background: "rgba(123,175,212,0.05)",
              ...
              <div style={{ position: "absolute", textAlign: "center" }}>
                <div style={{ fontSize: "3rem", fontWeight: 800, color: C.carolina }}>97%</div>
                <div style={{ fontSize: "0.7rem", fontFamily: "var(--font-mono)", color: C.muted }}>RELIANCE ON SEARCH</div>
              </div>
            </div>
            <div>
