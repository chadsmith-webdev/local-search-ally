            ...
            <div className={styles.heroScene}>
              <div className={styles.heroContent}>
                ...
                <div className={styles.heroActions}>
                  <Link href={`${process.env.NEXT_PUBLIC_AUDIT_URL}?city=Springdale`} className={styles.primaryBtn}>
                    Run Your Free Audit
                  </Link>
          ...
          <div className='container'>
            ...
            <div className={styles.spokeGrid}>
              <Link href='/service-areas/springdale-ar/hvac' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Springdale HVAC SEO →</span>
              </Link>
              <Link href='/service-areas/springdale-ar/plumbing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Springdale Plumbing SEO →</span>
              </Link>
              <Link href='/service-areas/springdale-ar/electrical' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Springdale Electrical SEO →</span>
              </Link>
              <Link href='/service-areas/springdale-ar/roofing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Springdale Roofing SEO →</span>
              </Link>
              <Link href='/service-areas/springdale-ar/landscaping' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Springdale Landscaping SEO →</span>
              </Link>
              <Link href='/service-areas/springdale-ar/remodeling' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Springdale Remodeling SEO →</span>
              </Link>
            </div>
          </div>
        </section>
