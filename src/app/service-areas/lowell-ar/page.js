            ...
            <div className={styles.heroScene}>
              <div className={styles.heroContent}>
                ...
                <div className={styles.heroActions}>
                  <Link href={`${process.env.NEXT_PUBLIC_AUDIT_URL}?city=Lowell`} className={styles.primaryBtn}>
                    Run Your Free Audit
                  </Link>
          ...
          <div className='container'>
            <div className={styles.sectionIntro} style={{marginBottom: "1.35rem"}}>
              ...
              <p className={styles.bodyCopy}>
                ...
                what local SEO means for your business in Lowell.
              </p>
            </div>
            <div className={styles.spokeGrid}>
              <Link href='/service-areas/lowell-ar/hvac' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Lowell HVAC SEO →</span>
              </Link>
              <Link href='/service-areas/lowell-ar/plumbing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Lowell Plumbing SEO →</span>
              </Link>
              <Link href='/service-areas/lowell-ar/electrical' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Lowell Electrical SEO →</span>
              </Link>
              <Link href='/service-areas/lowell-ar/roofing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Lowell Roofing SEO →</span>
              </Link>
              <Link href='/service-areas/lowell-ar/landscaping' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Lowell Landscaping SEO →</span>
              </Link>
              <Link href='/service-areas/lowell-ar/remodeling' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Lowell Remodeling SEO →</span>
              </Link>
            </div>
          </div>
        </section>
