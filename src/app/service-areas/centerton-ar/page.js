...
const pageUrl = "https://www.localsearchally.com/service-areas/centerton-ar";
          ...
          <div className='container'>
            ...
            <div className={styles.spokeGrid}>
              <Link href='/service-areas/centerton-ar/hvac' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Centerton HVAC SEO →</span>
              </Link>
              <Link href='/service-areas/centerton-ar/plumbing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Centerton Plumbing SEO →</span>
              </Link>
              <Link href='/service-areas/centerton-ar/electrical' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Centerton Electrical SEO →</span>
              </Link>
              <Link href='/service-areas/centerton-ar/roofing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Centerton Roofing SEO →</span>
              </Link>
              <Link href='/service-areas/centerton-ar/landscaping' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Centerton Landscaping SEO →</span>
              </Link>
              <Link href='/service-areas/centerton-ar/remodeling' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Centerton Remodeling SEO →</span>
              </Link>
            </div>
          </div>
        </section>
