...
const pageUrl = "https://www.localsearchally.com/service-areas/rogers-ar";
          ...
          <div className='container'>
            <div className={styles.sectionIntro} style={{marginBottom: "1.35rem"}}>
              ...
              <p className={styles.bodyCopy}>
                ...
                what local SEO means for your business in Rogers.
              </p>
            </div>
            <div className={styles.spokeGrid}>
              <Link href='/service-areas/rogers-ar/hvac' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Rogers HVAC SEO →</span>
              </Link>
              <Link href='/service-areas/rogers-ar/plumbing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Rogers Plumbing SEO →</span>
              </Link>
              <Link href='/service-areas/rogers-ar/electrical' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Rogers Electrical SEO →</span>
              </Link>
              <Link href='/service-areas/rogers-ar/roofing' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Rogers Roofing SEO →</span>
              </Link>
              <Link href='/service-areas/rogers-ar/landscaping' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Rogers Landscaping SEO →</span>
              </Link>
              <Link href='/service-areas/rogers-ar/remodeling' className={styles.spokeCard}>
                ...
                <span className={styles.spokeArrow}>See Rogers Remodeling SEO →</span>
              </Link>
            </div>
          </div>
        </section>
