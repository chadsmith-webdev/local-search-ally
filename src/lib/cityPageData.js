/**
 * City page content data
 * Each city key maps to all props consumed by CityPageClient
 */
...
export const cityPageData = {
  ...
  "rogers-ar": {
    ...
    state: "Arkansas",
    slug: "rogers-ar",
    auditCityParam: "Rogers",
    metaTitle: "Local SEO for Rogers Trades | Local Search Ally",
    metaDescription:
    ...
    briefBody:
      "This is not a market where a thin Google Business Profile and a generic service page quietly slide by. When demand spikes, the businesses with stronger local relevance get seen first.",
    signalsLabel: "What that means in Rogers",
    signals: [
    ...
    auditBody:
      "Rogers is one of the most active home service markets in Northwest Arkansas. More homeowners search before they call, and those searches often happen on mobile the moment a problem shows up.",
    faqTitle: "Questions I expect from Rogers trade owners",
    spokesEyebrow: "By trade",
    spokesTitle: "Rogers SEO by trade",
    tradeList: [
      "HVAC",
      "Plumbing",
      "Roofing",
  ...
  "cave-springs-ar": {
    ...
    auditCityParam: "Cave Springs",
    metaTitle: "Local SEO in Cave Springs, AR for Home Service Trades | Local Search Ally",
    metaDescription:
    ...
    signalsLabel: "What that means in Cave Springs",
    signals: [
    ...
    fitEyebrow: "Built for Cave Springs",
    tradeList: ["HVAC", "Plumbing", "Roofing", "Electrical", "Landscaping", "Remodeling"],
    focusAreas: [
      {
    ...
    auditEyebrow: "Why Cave Springs matters",
    auditTitle: "The market is arriving. Be ready.",
    auditStatement:
    ...
    faqTitle: "Questions I expect from Cave Springs trade owners",
    faqItems: [
      {
    ...
    spokesEyebrow: "By trade",
    spokesTitle: "Cave Springs SEO by trade",
  },
  ...
  "lowell-ar": {
    ...
    state: "Arkansas",
    slug: "lowell-ar",
    auditCityParam: "Lowell",
    metaTitle: "Local SEO in Lowell, AR for Home Service Trades | Local Search Ally",
    metaDescription:
    ...
    signalsLabel: "What that means in Lowell",
    signals: [
    ...
    auditEyebrow: "Why Lowell matters",
    auditTitle: "Demand with minimal competition",
    auditStatement:
    ...
    faqTitle: "Questions I expect from Lowell trade owners",
    faqItems: [
      {
