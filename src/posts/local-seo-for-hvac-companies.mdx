...
<figure className="my-8">
  <img
    src="https://images.pexels.com/photos/32497161/pexels-photo-32497161.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    alt="HVAC technician inspecting a residential air conditioning unit outside a home"
    className="rounded-lg shadow-lg w-full object-cover"
  />
  <figcaption className="text-sm text-center text-gray-500 mt-2">Photo by Pexels. HVAC work is local by nature — your Google presence should reflect that.</figcaption>
</figure>
...
<figure className="my-8">
  <img
    src="https://images.pexels.com/photos/5463580/pexels-photo-5463580.jpeg"
    alt="HVAC technician using gauge tools while repairing an air conditioning unit"
    className="rounded-lg shadow-lg w-full object-cover"
  />
  <figcaption className="text-sm text-center text-gray-500 mt-2">Photo by Pexels. The work you do every day is what homeowners are searching for — your GBP is how they find you before they can refer you.</figcaption>
</figure>
