...
faqs:
  - question: "Should I ask for a Google review in person, by text, or by email?"
    answer: "Text outperforms both. In-person asks feel comfortable but the customer is in motion and forgets by the time they're home. Email gets buried. A text sent the same day the job closes — while the customer is still thinking about the work — has the highest follow-through rate. Include the direct review link so it's one tap, not a search."
