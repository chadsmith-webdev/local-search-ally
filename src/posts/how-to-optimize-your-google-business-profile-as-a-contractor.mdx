...
## Step 7: Post to Your Profile Consistently

Google removed the Q&A feature from Business Profiles in 2024. The replacement — and a more effective ranking signal anyway — is Google Posts.

Posts appear directly on your profile and in Maps. They're indexed, they keep your profile looking active, and regular posting is one of the clearest signals to Google that your business is current and engaged. Most contractors never use them, which makes it a genuine low-effort edge.

What to post: completed jobs (trade + location + what you did), seasonal service reminders, before/after photos, and answers to common questions your customers ask. Keep each post to two or three sentences. Aim for one post per week — or at minimum biweekly. Posts expire after 90 days, so consistency matters more than volume.
