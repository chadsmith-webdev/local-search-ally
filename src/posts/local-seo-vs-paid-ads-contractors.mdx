...
<figure className='my-8'>
  <img
    src='/images/local-seo-vs-paid-ads-contractors.png'
    alt='Split-panel HUD dashboard comparing Local SEO vs Paid Ads for contractors — SEO panel showing Map Pack rank and compounding cost per lead, Paid Ads panel showing cost per click and budget dependency'
    className='rounded-lg shadow-lg w-full object-cover'
  />
  <figcaption className='text-sm text-center text-gray-500 mt-2'>
    AI-generated: Side-by-side comparison of Local SEO and Paid Ads performance
    metrics for NWA contractors.
  </figcaption>
</figure>
...
Google gives contractors two main paid options. If you're not yet clear on how the Map Pack works and why it matters, [this breakdown of how to get into the Google Map Pack](/blog/how-to-get-in-the-map-pack) is worth reading first.
...
Local SEO is the work you do to show up in Google's Map Pack and organic results without paying per click. The [complete local SEO guide for contractors](/blog/local-seo-for-contractors) goes deeper on every component if you want the full picture.
