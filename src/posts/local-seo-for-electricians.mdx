...
<figure className='my-8'>
  <img
    src='/images/electrician-gbp-diagnostic.png'
    alt='Google Business Profile diagnostic dashboard for a licensed electrician in NWA — GBP health readouts, Map Pack results, category signals, and service area coverage in a dark HUD layout.'
    className='rounded-lg shadow-lg w-full object-cover'
  />
  <figcaption className='text-sm text-center text-gray-500 mt-2'>
    AI-generated: GBP diagnostic dashboard for electrician local SEO — Google
    Business Profile mockup, Map Pack results, category and review signals,
    Carolina blue HUD accents, electrical schematic background.
  </figcaption>
</figure>
