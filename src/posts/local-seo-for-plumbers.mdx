...
> **Key Takeaways**
>
> - 42% of searchers click Map Pack results for local queries ([Backlinko](https://backlinko.com/), 2024) — for emergency plumbing searches, that concentration is even higher because people aren't browsing, they're calling
...
> - 88% of consumers who search for a local service on mobile call or visit within 24 hours ([Think With Google](https://thinkwithgoogle.com/)) — for plumbing, that window is often under an hour
